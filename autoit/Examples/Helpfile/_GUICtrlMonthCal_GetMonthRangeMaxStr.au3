...
Func Example()
	...
	; Get month range
	MemoWrite("Month range minimum: " & _GUICtrlMonthCal_GetMonthRangeMinStr($idMonthCal))
	MemoWrite("Month range maximum: " & _GUICtrlMonthCal_GetMonthRangeMaxStr($idMonthCal))
