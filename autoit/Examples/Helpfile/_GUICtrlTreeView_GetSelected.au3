...
Func Example()
	...
	GUICreate("TreeView Get Selected", 400, 300)
	...
	$iRand = Random(0, 9, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index %d Selected? %s", $iRand, _GUICtrlTreeView_GetSelected($idTreeView, $aidItem[$iRand])))
