...
Func Example()
	...
	GUICreate("TreeView Get Prev Sibling", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index %d, Prev: %s", $hRandItem, _GUICtrlTreeView_GetPrevSibling($idTreeView, $aidItem[$hRandItem])))
