...
Func Example()
	...
	MemoWrite("Margins are set Depending on Themes")
	MemoWrite("===================================")
	MemoWrite("Left Width.........: " & DllStructGetData($tMargins, "cxLeftWidth"))
	MemoWrite("Right Width........: " & DllStructGetData($tMargins, "cxRightWidth"))
	MemoWrite("Top Height.........: " & DllStructGetData($tMargins, "cyTopHeight"))
	MemoWrite("Bottom Height......: " & DllStructGetData($tMargins, "cyBottomHeight"))
	MemoWrite("======================")
