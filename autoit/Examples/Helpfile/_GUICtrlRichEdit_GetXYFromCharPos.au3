...
Func Example()
	Local $hGui, $hRichEdit, $iMsg, $aiPos, $idBtnNext, $iStep = 0
		...
		Select
			...
			Case $iMsg = $idBtnNext
				...
				Switch $iStep
					...
					Case 2
						Report("2.The inter-character position at or nearest coordinates (" & $aiPos[0] & "," & $aiPos[1] & ") is " & _
								_GUICtrlRichEdit_GetCharPosFromXY($hRichEdit, $aiPos[0], $aiPos[1]))
