...
Func Example()
	...
	Else
		_GUICtrlListView_SetGroupInfo($idListview, 1, "New Group 1", 0, $LVGS_FOCUSED)
		MsgBox($MB_SYSTEMMODAL, "Information", "Group has focus at Index: " & _GUICtrlListView_GetFocusedGroup($idListview))
	EndIf
