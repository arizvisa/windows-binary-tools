...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setting Gripper Always Style")
	_GUICtrlRebar_SetBandStyleGripperAlways($hReBar, 1, False)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		MemoWrite("Band Index " & $x & @TAB & "$RBBS_GRIPPERALWAYS.: " & _GUICtrlRebar_GetBandStyleGripperAlways($hReBar, $x))
		MemoWrite("============================================")
	Next
