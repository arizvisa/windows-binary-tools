...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setting Variable Height Style")
	_GUICtrlRebar_SetBandStyleVariableHeight($hReBar, 1)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		MemoWrite("Band Index " & $x & @TAB & "$RBBS_VARIABLEHEIGHT: " & _GUICtrlRebar_GetBandStyleVariableHeight($hReBar, $x))
		MemoWrite("============================================")
	Next
